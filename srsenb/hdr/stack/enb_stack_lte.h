...
// Wrappers
#include "funsplit/gtpu_rrc_wrapper.h"
#include "funsplit/mac_rlc_wrapper.h"
#include "funsplit/mac_rrc_wrapper.h"
#include "funsplit/pdcp_rlc_wrapper.h"
#include "funsplit/pdcp_rrc_wrapper.h"
#include "funsplit/rlc_mac_wrapper.h"
#include "funsplit/rlc_pdcp_wrapper.h"
#include "funsplit/rlc_rrc_wrapper.h"
#include "funsplit/rrc_gtpu_wrapper.h"
#include "funsplit/rrc_mac_wrapper.h"
#include "funsplit/rrc_pdcp_wrapper.h"
#include "funsplit/rrc_rlc_wrapper.h"

#include "funsplit/phy_rrc_wrapper.h"
// #include "funsplit/rrc_phy_wrapper.h"

#include "funsplit/mac_phy_wrapper.h"
#include "funsplit/phy_mac_wrapper.h"

#include "funsplit/phy_stack_proxy.h"
#include "funsplit/stack_phy_proxy.h"
...
namespace srsenb
{
  ...
  private:
    ...
    void stop_impl();
    void tti_clock_impl();
    int initMAC(const stack_args_t &args);
    int initRLC(const stack_args_t &args);
    int initPDCP(const stack_args_t &args);
    int initRRC(const stack_args_t &args);
    int initS1AP(const stack_args_t &args);
    int initGTPU(const stack_args_t &args);
    ...
    /* Wrappers */
    srsenb::pdcp_rlc_wrapper pdcp_rlc_wrapper; // Wrapper PDCP-RLC
    srsenb::rlc_pdcp_wrapper rlc_pdcp_wrapper; // Wrapper RLC-PDCP
    srsenb::mac_rrc_wrapper mac_rrc_wrapper;   // Wrapper MAC-RRC
    srsenb::rrc_mac_wrapper rrc_mac_wrapper;   // Wrapper RRC-MAC
    srsenb::pdcp_rrc_wrapper pdcp_rrc_wrapper; // Wrapper PDCP-RRC
    srsenb::rrc_pdcp_wrapper rrc_pdcp_wrapper; // Wrapper RRC-PDCP
    srsenb::rlc_rrc_wrapper rlc_rrc_wrapper;   // Wrapper RLC-RRC
    srsenb::rrc_rlc_wrapper rrc_rlc_wrapper;   // Wrapper RRC-RLC
    srsenb::gtpu_rrc_wrapper gtpu_rrc_wrapper; // Wrapper GTPU-RRC
    srsenb::rrc_gtpu_wrapper rrc_gtpu_wrapper; // Wrapper RRC-GTPU
    srsenb::mac_rlc_wrapper mac_rlc_wrapper;   // Wrapper MAC-RLC
    srsenb::rlc_mac_wrapper rlc_mac_wrapper;   // Wrapper RLC-MAC

    srsenb::phy_rrc_wrapper phy_rrc_wrapper; // Wrapper PHY-RRC
    srsenb::phy_mac_wrapper phy_mac_wrapper; // Wrapper PHY-MAC

    // stack_phy_proxy stack_phy;
    phy_stack_proxy phy_stack;
